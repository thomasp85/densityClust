...
#' Cluster detection
#' 
#' The two main functions for this package are \code{\link{dclust}} and 
...
#' latter takes the output of \code{\link{dclust}} and make cluster 
...
#' 
#' @seealso \code{\link{dclust}}, \code{\link{findClusters}}, \code{\link{plotMDS}}
#' 
